...
class Task1Test {
    ...
    /*Тесты по задаче 1*/
    @Test
    void setBalanceValueInCorrectRange() {

        task1.setBalance(Short.MAX_VALUE);

        assertEquals(32767, task1.setBalance());
    }

    @Test
    void setDistanceValueInCorrectRange() {

        task1.setDistance(Long.MAX_VALUE);

        assertEquals(9223372036854775807L, task1.setDistance());
    }

    @Test
    void setRegionValueInCorrectRange() {

        task1.setRegion(Char.MAX_VALUE);

        assertEquals(Character.MAX_VALUE, task1.setRegion());
    }

    @Test
    void setRemainderOfDivisionValueInCorrectRange() {

        task1.RemainderOfDivision(Float.MAX_VALUE);

        assertEquals(3.4e+38f, task1.setRemainderOfDivision());
    }

    @Test
    void setRemainderOfDivisionTwoValueInCorrectRange() {

        task1.RemainderOfDivisionTwo(Double.MAX_VALUE);

        assertEquals(1.7e+308, task1.setRemainderOfDivisionTwo());
    }

    @Test
    void setYearValueInCorrectRange() {

        task1.setYear(Int.MAX_VALUE);

        assertEquals(2147483647, task1.setYear());
    }

    @Test
    void setIsReadValueInCorrectRange() {

        task1.setIsRead(Boolean.MAX_VALUE);

        assertEquals(Boolean.MAX_VALUE, task1.setIsRead());
    }

    @Test
    void setIsWriteValueInCorrectRange() {

        task1.setIsWrite(Boolean.MAX_VALUE);

        assertEquals(Boolean.MAX_VALUE, task1.setIsWrite());
    }
    ...
    /*Задача 2 - тест на суммирование*/
    @Test
    void getCorrectSum2() {

        int param = 15;
        task1.setBalance(param);

        assertEquals(30, task1.getSum2((int) 5, (long) 10));
    }
    ...
    void getNotExpectedValueFromSum() {
        ...
        assertEquals(0, task1.getSum2((int) 5, (long) 10));
    }

    /*Задачи 4 и 5 и 6 - то же самое, что и задача 3, только проверяем на другое значение, 40 вместо 0*/
    @Test
    void getNotExpectedValueFromSum() {
        int param = 15;
        ...
        assertEquals(40, task1.getSum2((int) 5, (long) 10));
    }
}